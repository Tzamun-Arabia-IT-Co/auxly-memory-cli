...
## How Cursor Should Use This Memory
- Cursor connects to Auxly via the Auxly VSIX extension (MCP tools).
...
auxly_memory_write  file=preferences.md diff="+- Style: terse" reason="User preference" provider="cursor"
